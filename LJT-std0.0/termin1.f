...
c             Additional diagnostic code
	      ...
	      write(26,49) rho(ix,iy,iz)
              write(26,800) (rho(kx,iy-1,iz-1),kx=ix-1,ix+1)
              write(26,801) (rho(kx,iy,iz-1),kx=ix-1,ix+1)
              write(26,801) (rho(kx,iy+1,iz-1),kx=ix-1,ix+1)
              write(26,802) (rho(kx,iy-1,iz),kx=ix-1,ix+1)
              write(26,802) (rho(kx,iy,iz),kx=ix-1,ix+1)
              write(26,802) (rho(kx,iy+1,iz),kx=ix-1,ix+1)
              write(26,803) (rho(kx,iy-1,iz+1),kx=ix-1,ix+1)
              write(26,803) (rho(kx,iy,iz+1),kx=ix-1,ix+1)
              write(26,803) (rho(kx,iy+1,iz+1),kx=ix-1,ix+1)

	      write(26,51) u(ix,iy,iz),2.*u(ix,iy,iz)**gamma
              write(26,810) (2.*u(kx,iy-1,iz-1)**gamma,kx=ix-1,ix+1)
              write(26,801) (2.*u(kx,iy,iz-1)**gamma,kx=ix-1,ix+1)
              write(26,801) (2.*u(kx,iy+1,iz-1)**gamma,kx=ix-1,ix+1)
              write(26,802) (2.*u(kx,iy-1,iz)**gamma,kx=ix-1,ix+1)
              write(26,802) (2.*u(kx,iy,iz)**gamma,kx=ix-1,ix+1)
              write(26,802) (2.*u(kx,iy+1,iz)**gamma,kx=ix-1,ix+1)
              write(26,803) (2.*u(kx,iy-1,iz+1)**gamma,kx=ix-1,ix+1)
              write(26,803) (2.*u(kx,iy,iz+1)**gamma,kx=ix-1,ix+1)
              write(26,803) (2.*u(kx,iy+1,iz+1)**gamma,kx=ix-1,ix+1)

              write(26,820) (2.*u(kx,iy-1,iz-1)**gamma/
     +                 rho(kx,iy-1,iz-1),kx=ix-1,ix+1)
              write(26,801) (2.*u(kx,iy,iz-1)**gamma/
     +                 rho(kx,iy,iz-1),kx=ix-1,ix+1)
              write(26,801) (2.*u(kx,iy+1,iz-1)**gamma/
     +                 rho(kx,iy+1,iz-1),kx=ix-1,ix+1)
              write(26,802) (2.*u(kx,iy-1,iz)**gamma/
     +                 rho(kx,iy-1,iz),kx=ix-1,ix+1)
              write(26,802) (2.*u(kx,iy,iz)**gamma/
     +                 rho(kx,iy,iz),kx=ix-1,ix+1)
              write(26,802) (2.*u(kx,iy+1,iz)**gamma/
     +                 rho(kx,iy+1,iz),kx=ix-1,ix+1)
              write(26,803) (2.*u(kx,iy-1,iz+1)**gamma/
     +                 rho(kx,iy-1,iz+1),kx=ix-1,ix+1)
              write(26,803) (2.*u(kx,iy,iz+1)**gamma/
     +                 rho(kx,iy,iz+1),kx=ix-1,ix+1)
              write(26,803) (2.*u(kx,iy+1,iz+1)**gamma/
     +                 rho(kx,iy+1,iz+1),kx=ix-1,ix+1)
...
c
     ...
     +               (indy(iy) .ne. 1) .AND. (indy(iy) .ne. ny) .AND.
     +               (indz(iz) .ne. 1) .AND. (indz(iz) .ne. nz)) then
                    u(indx(ix),indy(iy),indz(iz)) = uprof(indz(ix))
